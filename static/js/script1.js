/**
 * Created by abajuk on 02.06.2017.
 */
...
function countUsers() {
    ...
    for (var i = 0; i < mapa.length; i++) {
        ...
        if (tableCell) {
            var classEl;
            var classElPar;
            var color = tableCell.getAttribute('class');
            switch (color) {
                case 'green':
                    classEl= document.getElementById('11.11');
                    classElPar = classEl.querySelector('p');
                    count++;
                    classElPar.innerHTML = count;
                    break;
                case 'away':
                    classEl = document.getElementById('11.12');
                    classElPar = classEl.querySelector('p');
                    count1++;
                    classElPar.innerHTML = count1;
                    break;
                case 'dontDisturb':
                    classEl = document.getElementById('11.13');
                    classElPar = classEl.querySelector('p');
                    count2++;
                    classElPar.innerHTML = count2;
                    break;
                case 'busy':
                    classEl = document.getElementById('11.14');
                    classElPar = classEl.querySelector('p');
                    count3++;
                    classElPar.innerHTML = count3;
                    break;
                case 'comeBackSoon':
                    ...
                    break;
                case 'brake':
                    classEl = document.getElementById('11.16');
                    classElPar = classEl.querySelector('p');
                    count5++;
                    classElPar.innerHTML = count5;
                    break;
                case 'grey':
                    classEl = document.getElementById('11.17');
                    classElPar = classEl.querySelector('p');
                    count6++;
                    classElPar.innerHTML = count6;
                    break;
                }
            }
        }
